...
TEST_F(EnumtreeTest, trees_cons)
{
  for (int t=0; t<(int)x.size(); ++t)
    {
      ...
      EXPECT_EQ(x[t][0].brother_index, 0);
  ...
  EXPECT_EQ(x[0][1].brother_index, 0);
  ...
  EXPECT_EQ(x[0][2].brother_index, 0);
  ...
  EXPECT_EQ(x[0][3].brother_index, 0);
  ...
  EXPECT_EQ(x[0][4].brother_index, 0);
  ...
  EXPECT_EQ(x[1][1].brother_index, 0);
  ...
  EXPECT_EQ(x[1][2].brother_index, 0);
  ...
  EXPECT_EQ(x[1][3].brother_index, 0);
  ...
  EXPECT_EQ(x[1][4].brother_index, 1);
  ...
  EXPECT_EQ(x[2][1].brother_index, 0);
  ...
  EXPECT_EQ(x[2][2].brother_index, 0);
  ...
  EXPECT_EQ(x[2][3].brother_index, 0);
  ...
  EXPECT_EQ(x[2][4].brother_index, 1);
  ...
  EXPECT_EQ(x[3][1].brother_index, 0);
  ...
  EXPECT_EQ(x[3][2].brother_index, 0);
  ...
  EXPECT_EQ(x[3][3].brother_index, 1);
  ...
  EXPECT_EQ(x[3][4].brother_index, 0);
  ...
  EXPECT_EQ(x[4][1].brother_index, 0);
  ...
  EXPECT_EQ(x[4][2].brother_index, 0);
  ...
  EXPECT_EQ(x[4][3].brother_index, 1);
  ...
  EXPECT_EQ(x[4][4].brother_index, 2);
