...
\begin{align}
& \int_{0}^{1} dx_i \int_{t_{\mathrm{child}(i)}}^{t_i} dt f_{WF}\left(x_i\Big|\frac{1}{Nn_i(t)}, t\right) + \int_{t_{\mathrm{child}(i)}}^{t_i} dt p_{WF}\left(1\Big|\frac{1}{Nn_i(t)}, t\right) + \int_{t_{\mathrm{child}(i)}}^{t_i} dt p_{WF}\left(0\Big|\frac{1}{Nn_i(t)}, t\right)\nonumber\\
