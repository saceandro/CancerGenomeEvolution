...
One of the first computational method which attack the first problem mentioned above is ABSOLUTE~\cite{carter2012absolute}, which enabled the estimation of the tumor purity and the ploidy avaraged over all the subtypes.
...
Then THetA~\cite{williams2016identification} and TITAN~\cite{ha2014titan} were desined to attack the second and third problem mentioned above.
...
.
Subtype abundance ratio estimation using the single nucleotide variations (SNVs) was conducted by SciClone and PyClone.
