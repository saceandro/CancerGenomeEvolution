...
if lines > 201:
    with open(f_name, "r") as f:
        for i in range(split_num):
            if rest > 0:
                with open("../data_snv_seed_rand/" + str(file_len) + "/" + str(seed) + "/" + str(i), "w") as g:
    ...
    #     with open("data_snv_seed_rand/" + str(i), "w") as g:
    #         for j in range(lines):
    #             g.write(f.readline())
    #         g.close()
    # with open("data_snv_seed_rand/" + str(split_num-1), "w") as g:
