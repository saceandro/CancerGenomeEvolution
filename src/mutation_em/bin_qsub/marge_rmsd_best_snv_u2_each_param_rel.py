...
u2_2 = sys.argv[2]
# u2_3 = sys.argv[3]
marged_bestfile = filebase + 'bests_rel'
bestfile1 = filebase_u1 + u2_1 + '/3/3000/bests_rel'
bestfile2 = filebase_u1 + u2_2 + '/3/3000/bests_rel'
# bestfile3 = filebase_u1 + u2_3 + '/3/3000/bests_rel'
