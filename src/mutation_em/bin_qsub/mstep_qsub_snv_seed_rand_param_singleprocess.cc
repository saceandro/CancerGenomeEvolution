...
struct ComputeFdf {
  ...
  int operator()(const Vdouble& x, double& fn, vector<double>& gr)
  {
    ...
    //   {
        ...
        // datafile_id << sp;
        system(("./estep_snv_seed_rand_param_singleprocess.sh " + u1 + " " + u2 + " " + n + " " + snvs + " " + seed + " " + est_iter + " 0").c_str());
      // }
...
int main(int argc, char* argv[]) {
  ...
  if (argc != 23)
    {
      cerr << "usage: ./mstep_qsub_snv_seed_rand_param_singleprocess subtype topology num_of_split (x y init infile) (pa_test outfile) (vf_test outfile) (llik outfile) (pa_best outfile) (vf_old outfile) (params log fie) (true params) (rmsd file) (param difference) (u1) (u2) (n) (#SNV) (seed) (iter) (u lower bound) (em max iter) (grad desc max iter)" << endl;
      exit(EXIT_FAILURE);
    }
