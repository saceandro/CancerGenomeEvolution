...
#$ -S /usr/local/bin/zsh
#$ -cwd
#$ -e ../log_qsub_snv_seed_rand/esteperr
#$ -o ../log_qsub_snv_seed_rand/esteplog
...
filename=../data_snv_seed_rand/${snvs}/${seed}/${datafile_id}
...
du_dn_llik=../du_dn_llik_qsub_snv_seed_rand/${snvs}/${seed}/${iter}/$datafile_id
