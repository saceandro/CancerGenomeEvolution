...
qsub -N em_snv${snvs}_seed${seed}_rand_param${u1}_${u2}_${n} -tc 100 -t 1-10:1 mstep_snv_seed_rand_param_singleprocess.sh $u1 $u2 $n $snvs $seed $fileNum $pa_true $u_lower $em_max_iter $grad_desc_max_iter
