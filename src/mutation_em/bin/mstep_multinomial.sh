...
./grad_desc_multinomial 2 0 $num_of_split $pa_old $pa_test $vf_dvf_test $llik $dx_dy 1e-5 1e-7 # 1> ../log/m${iteration}_${SGE_TASK_ID}.log 2> ../log/m${iteration}_${SGE_TASK_ID}.err
